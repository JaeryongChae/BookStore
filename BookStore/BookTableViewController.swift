...
//        books.append(book3)
        ...
        var filePath = dirPaths[0] as String
        filePath += "/bookData"
        
        //NSKeyedArchiver.archiveRootObject(books, toFile: filePath)
        //toFile에는 Directory까지 명시해야 함.
        //Application내 Document, tmp Directory가 있으며 Document의 경우 입력된 정보가 Update시 자동 저장됨.
        //따라서 주요 Data는 Document Directory에 저장해야 함.
        
        books = NSKeyedUnarchiver.unarchiveObjectWithFile(filePath) as! [Book]
    }
